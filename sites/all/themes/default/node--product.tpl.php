...
<div class="journey">
  ...
  <div class="page-1000">
    ...
    <?php print render($page['ceiling']); ?>
      ...
      <?php print $messages; ?>
      <div class="row">
      	<div class="col-xs-12 col-sm-8 fold-8 prt-sm">
        	<div class="col-xs-12 col-md-4 prt-sm">
          	<div class="hidden-xs hidden-sm">
          		<?php print render($page['sidebar_second']); ?>
        		</div><!-- end hidden-xs hidden-sm -->
          </div><!-- end col-xs-12 col-sm-4 -->
          <div class="col-xs-12 col-md-8 plt-sm">
      ...
      <?php print render($title_suffix); ?>
        ...
        </div><!-- end col-12 col-sm-8 fold-8 -->
        <div class="col-xs-12 col-sm-4 fold-4 plt-sm">
        	<?php print render($page['help']); ?>
       		<?php print render($page['sidebar_first']); ?>
         <div class="visible-xs visible-sm">
						<?php print render($page['sidebar_second']); ?>
          </div><!-- end hidden-xs hidden-sm -->
        </div><!-- end col-xs-12 col-sm-4 fold-4 -->
      </div><!-- end row -->
